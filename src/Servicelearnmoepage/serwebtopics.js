...
const cards = [
  ...
  },
  {
    ...
    text:
      "We build intuitive mobile applications that deliver flawless performance and user delight — from startups to enterprise-grade solutions.",
    img: scan,
  },
  {
    title: "UI/UX Design & Prototyping (Figma / Adobe XD)",
    text:
      "We deliver flexible, easy-to-manage CMS websites that empower your team to update, launch, and grow without technical hassle.",
    img: chat,
  },
  {
  ...
  },
  {
    ...
    text:
      "Our developers build secure and scalable APIs that connect applications, automate workflows, and ensure smooth communication across your platforms and third-party services.",
    img: dataviz,
  },
];
