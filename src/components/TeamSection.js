...
import teamBanner from "../images/Nimabout.png";
...
const TeamSection = () => {
  ...
  useEffect(() => {
    ...
    const elements = [bannerRef.current, textRef.current];
      ...
      <div className="container">
        ...
        <div className="row justify-content-center">
          <div className="col-12">
            <div
              ref={bannerRef}
              className="team-banner fade-init"
        ...
        <div className="row mt-5">
          <div className="col-12">
            <p ref={textRef} className="team-description fade-init">
