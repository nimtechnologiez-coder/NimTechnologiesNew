...
const Nimbook = () => {
  ...
  return (
    <div >
      <Helmet>
        <title>Nim Books – Smart Business &amp; Accounting Software | NIM Tech</title>
        <meta
          name="description"
          content="NimBooks is a smart business &amp; accounting solution by NIM Technologies that turns numbers into actionable insights to help manage finances &amp; grow your business."
        />
      </Helmet>
      {/* Hero Section */}
